...
<img src="/content/media/images/quickstart/new_project/warp_click_create_new_project_link.png" alt="Warp 'Projects' page. The reader is instructed to click the 'Create a New Project' link." />
...
<img src="/content/media/images/quickstart/new_project/warp_click_create_new_project_link_2.png" alt="Warp 'Projects' page. The reader is instructed to click the 'Install Warp from the GitHub Marketplace' button." />

🛠️ Click the the **Install Warp from the GitHub Marketplace** link. 

You will arrive at the page for the Warp GitHub app:

<img src="/content/media/images/quickstart/new_project/github_packfiles_warp_github_app.png" alt="GitHub 'Packfiles Warp GitHub App' page. The reader is instructed to click the 'Configure' button." />
...
<img src="/content/media/images/quickstart/new_project/github_install_packfiles_warp_install.png" alt="GitHub 'Install Packfiles Warp' details page. The reader is instructed to click the 'Install' button." />
...
<img src="/content/media/images/quickstart/new_project/warp_welcome_to_warp.png" alt="Warp 'Welcome to Warp' page. The reader is instructed to click the 'Next' button." />
...
<img src="/content/media/images/quickstart/new_project/warp_configure_your_project.png" alt="Warp 'Configure Your Project' page. The reader is instructed to click the 'Next' button." />
...
<img src="/content/media/images/quickstart/new_project/warp_connect_your_sources.png" alt="Warp 'Connect Your Sources' page. The reader is instructed to click the 'Migration HQ' button." />
...
<img src="/content/media/images/quickstart/new_project/github_migration-hq_initial.png" alt="The 'Migration HQ' repository in GitHub. The reader is instructed to clone 'Migration HQ' to their local computer." />
...
<img src="/content/media/images/quickstart/ado_pat/ado_organizations.png" alt="ADO 'Azure DevOps Organizations' page. The reader is instructed to select the organization whose repositories are to be migrated to GitHub." />
...
<img src="/content/media/images/quickstart/ado_pat/ado_slug_explainer.png" alt="Azure Devops organization page for the 'joey-ado-testing' organization. The slug part of the URL is pointed out in the browser address bar." />
...
<img src="/content/media/images/quickstart/ado_pat/ado_organization.png" alt="ADO organization page for the selected organization. The reader is instructed to click the 'User Settings' icon and then select 'Personal access tokens' from its menu." />
...
<img src="/content/media/images/quickstart/ado_pat/ado_personal_access_tokens_initial.png" alt="ADO 'Personal Access Tokens' page. The reader is instructed to click any 'New Token' button." />

🛠️ Click any of the **New Token** buttons on the page.

A panel will appear, prompting you to create a new personal access token:

<img src="/content/media/images/quickstart/ado_pat/ado_create_a_new_personal_access_token.png" alt="ADO 'Create a new personal access token' panel. The reader is instructed to change the 'Scopes' option to 'Full access', enter a name for the token, and click the 'Create' button." />
...
<img src="/content/media/images/quickstart/ado_pat/ado_new_pat_success.png" alt="ADO 'Success!' panel. The reader is instructed to copy the personal access token and then click the 'Close' button." />
...
<img src="/content/media/images/quickstart/ado_pat/ado_personal_access_tokens_new_token.png" alt="ADO 'Personal Access Tokens' page, now updated with the newly-created token." />
...
<img src="/content/media/images/quickstart/gh_pat/github_profile_picture_menu.png" alt="GitHub 'Migration HQ' page. The reader is instructed to click on their profile picture, then select 'Settings' from the menu that appears." />
...
<img src="/content/media/images/quickstart/gh_pat/github_select_developer_settings.png" alt="GitHub user account 'Settings' page. The reader is instructed to select 'Developer Settings' from the menu on the left side of the page." />
...
<img src="/content/media/images/quickstart/gh_pat/github_expand_pat_menu.png" alt="GitHub 'Developer Settings' page. The reader is instructed to expand the 'Personal access tokens' menu, then select 'Tokens (classic)' from the menu." />
...
<img src="/content/media/images/quickstart/gh_pat/github_generate_new_token.png" alt="GitHub 'Personal access tokens (classic)' page. The reader is instructed to click the 'Generate new token' button, then select 'Generate new token (classic) from the menu that appears." />
...
<img src="/content/media/images/quickstart/gh_pat/github_new_pat_settings_1.png" alt="GitHub 'New personal access token (classic)' page. The reader is instructed to enter a name for the token and check 'repo', 'workflow', 'write:packages', and 'delete:pacakages'." />
...
<img src="/content/media/images/quickstart/gh_pat/github_new_pat_settings_2.png" alt="GitHub 'New personal access token (classic)' page, scrolled father down. The reader is instructed to check 'admin:org', 'admin:repo_hook', and 'delete_repo'." />
...
<img src="/content/media/images/quickstart/gh_pat/github_new_pat_settings_3.png" alt="GitHub 'New personal access token (classic)' page, scrolled father down. The reader is instructed to click the 'Generate token' button." />
...
<img src="/content/media/images/quickstart/gh_pat/github_personal_access_tokens_new_token.png" alt="GitHub 'Personal access tokens (classic)' page. The reader is instructed to copy the personal access token." />
...
<img src="/content/media/images/quickstart/vault_setup/vault_setup_start.png" alt="Warp command-line vault setup application. The reader is welcomed to the app and instructed to press the 'Enter' or 'Return' key." />
...
<img src="/content/media/images/quickstart/vault_setup/vault_setup_add_new_provider_1.png" alt="Warp command-line 'Configure Providers' menu. The 'Add a New Provider' option is selected." />

🛠️ The default option, **Add a New Provider**, is the one you want. Press the **Enter** or **Return** key to select this option.

<img src="/content/media/images/quickstart/vault_setup/vault_setup_select_add_ado_credentials.png" alt="Warp command-line 'Add Provider Credentials' menu. The 'Azure DevOps' option is selected." />
...
<img src="/content/media/images/quickstart/vault_setup/vault_setup_ado_access_scope.png" alt="Warp command-line 'Access Scope' menu. The 'Signle organization access' menu item is selected." />
...
<img src="/content/media/images/quickstart/vault_setup/vault_setup_paste_github_pat.png" alt="Warp command-line 'Configure GitHub Destination' menu" />

🛠️ Paste your GitHub personal access token into the text area marked **Your PAT**...

<img src="/content/media/images/quickstart/vault_setup/vault_setup_pasted_github_pat.png" alt="Warp command-line 'Configure GitHub Destination' menu" />
...
<img src="/content/media/images/quickstart/vault_setup/vault_setup_paste_gh_org_slug.png" alt="Warp command-line 'Configure GitHub Destination' menu" />

In this example, the slug is `Hypotheticorp5678`:

<img src="/content/media/images/quickstart/vault_setup/vault_setup_pasted_gh_org_slug.png" alt="Warp command-line 'Configure GitHub Destination' menu" />
...
<img src="/content/media/images/quickstart/vault_setup/vault_setup_confirm_github.png" alt="Warp command-line 'Confirmation' prompt" />
...
<img src="/content/media/images/quickstart/vault_setup/vault_setup_commit_and_push_changes.png" alt="Warp command-line 'Configure Providers' menu" />
...
<img src="/content/media/images/quickstart/connect_ado/warp_dashboard_initial.png" alt="Warp Deashboard page" />
...
<img src="/content/media/images/quickstart/migrate/github_issue_1.png" alt="Warp Sign In page" />
...
<img src="/content/media/images/quickstart/migrate/github_issue_2.png" alt="Warp Sign In page" />
...
<img src="/content/media/images/quickstart/migrate/github_issue_3.png" alt="Warp Sign In page" />
...
<img src="/content/media/images/quickstart/migrate/github_issue_4.png" alt="Warp Sign In page" />

It’s time to migrate!

🛠️ Scroll down the page to the comments section...

<img src="/content/media/images/quickstart/migrate/github_issue_start_migration.png" alt="Warp Sign In page" />
...
<img src="/content/media/images/quickstart/migrate/github_issue_migration_in_process_comment.png" alt="Warp Sign In page" />
...
<img src="/content/media/images/quickstart/migrate/actions_tab_1.png" alt="Warp Sign In page" />
...
<img src="/content/media/images/quickstart/migrate/actions_tab_2.png" alt="Warp Sign In page" />
...
<img src="/content/media/images/quickstart/migrate/post-migration_open_issues.png" alt="Warp Sign In page" />
...
<img src="/content/media/images/quickstart/migrate/post-migration_closed_issues.png" alt="Warp Sign In page" />

🛠️ Examine the issue by clicking it:

<img src="/content/media/images/quickstart/migrate/closed_issue_1.png" alt="Warp Sign In page" />
...
<img src="/content/media/images/quickstart/migrate/closed_issue_2.png" alt="Warp Sign In page" />
...
<img src="/content/media/images/quickstart/migrate/closed_issue_3.png" alt="Warp Sign In page" />
...
<img src="/content/media/images/quickstart/migrate/migrated_repo.png" alt="Warp Sign In page" />
