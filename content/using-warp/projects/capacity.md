...
<figure><img src="../../.gitbook/assets/image (7).png" alt="" width="168"><figcaption></figcaption></figure>
...
* It gives you the ability to set the amount of capacity to purchase. You can set this amount in a couple of ways:
  ...
  * You can click the **Optimize** button, which automatically enters the optimal quantities for purchasing enough capacity to handle your remaining repositories to migrate. You can clear the effects of the **Optimize** button by clicking the <img src="../../.gitbook/assets/image (10).png" alt="" data-size="line"> button.
